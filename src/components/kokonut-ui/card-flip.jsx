    ...
    >
      ...
      >
          ...
          <div className="absolute right-0 bottom-0 left-0 p-5">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="group/icon relative">
                ...
                />
                <Icon className="group-hover/icon:-rotate-12 relative z-10 h-4 w-4 text-orange-500 transition-transform duration-300 group-hover/icon:scale-110" />
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="mt-6 border-zinc-200 border-t pt-6 dark:border-zinc-800 flex justify-center">
            <button
              onClick={onNavigate}
              type="button"
              className={cn(
                ...
                "hover:scale-[1.02] hover:cursor-pointer w-full",
              )}
            >
